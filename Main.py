...
from structured_products_pricing.Products.Bond.BondZC import ZeroCouponBond
...
##### Test Taux #####
pricer = DiscountingPricer(pricing_date=datetime(2025, 1, 1), day_count='act/365.25')

# Zero Coupon Bond
zc = ZeroCouponBond(notional=1, maturity_date='2027-01-01')
price_zcb = pricer.price(zc, Market_Info)
...
price_frb = pricer.price(bond, Market_Info, clean=False)
...
price = pricer.price(flb, Market_Info)
