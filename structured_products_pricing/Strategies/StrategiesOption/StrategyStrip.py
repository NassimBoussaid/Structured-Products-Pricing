...
class StrategyStrip(StrategyBase):
    """
    Class to define a Strip strategy, extending from StrategyBase.

    A Strip involves:
    - Long one call and two puts at the same strike and maturity,
    """
    def __init__(self, MarketObject: Market, PricerObject: PricerBase, strike: float, maturity_date: datetime):
        ...
        - strike: float. Common strike price for both the call and the puts.
